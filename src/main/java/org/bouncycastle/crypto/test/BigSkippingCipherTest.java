    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        {
            Companion.fail("long seek failed");
        }
        ...
        {
            Companion.fail("zero position came back as: " + skippingEngine.getPosition());
        }
        ...
        {
            Companion.fail("long output mismatch");
        }
    }
        ...
        throws Exception
    {
        ...
        for (long i = 0; i != 1L << 20; i++)
        {
            ...
            {
                Companion.fail(i + "th position came back as: " + skippingEngine.getPosition());
            }
            ...
            {
                Companion.fail("output mismatch");
            }

            if (skippingEngine.getPosition() != startDataBuf.length + (i + 1) * incBuf.length)
            {
                Companion.fail(i + "th + 1 position came back as: " + skippingEngine.getPosition());
            }
