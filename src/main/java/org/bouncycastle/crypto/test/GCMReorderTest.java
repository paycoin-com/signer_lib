    ...
    extends TestCase
{
    ...
    public void testCombine() throws Exception
    {
        for (int count = 0; count < 10; ++count)
        {
            ...
            Companion.assertTrue(Arrays.areEqual(ghashAC, ghashCombine));
        }
    }
    ...
    public void testConcatAuth() throws Exception
    {
        for (int count = 0; count < 10; ++count)
        {
            ...
            Companion.assertTrue(Arrays.areEqual(ghashPA_, ghashConcat));
        }
    }
    ...
    public void testConcatCrypt() throws Exception
    {
        for (int count = 0; count < 10; ++count)
        {
            ...
            Companion.assertTrue(Arrays.areEqual(ghash_PA, ghashConcat));
        }
    }
    ...
    {
        {
            ...
            for (int pow = 0; pow != 100; ++pow)
            {
                ...
                Companion.assertTrue(Arrays.areEqual(buf1, buf2));
        ...
        for (int i = 0; i != 10; ++i)
        {
            ...
            Companion.assertTrue(Arrays.areEqual(expected, actual));
        }
    }
    ...
    public void testMultiply()
    {
        ...
        Companion.assertTrue(Arrays.areEqual(expected, multiply(H, H)));
        ...
        for (int count = 0; count < 10; ++count)
        {
            ...
            mul.multiplyH(expected);
            Companion.assertTrue(Arrays.areEqual(expected, multiply(a, H)));
            Companion.assertTrue(Arrays.areEqual(expected, multiply(H, a)));

            expected = Arrays.clone(b);
            mul.multiplyH(expected);
            Companion.assertTrue(Arrays.areEqual(expected, multiply(b, H)));
            Companion.assertTrue(Arrays.areEqual(expected, multiply(H, b)));

            Companion.assertTrue(Arrays.areEqual(multiply(a, b), multiply(b, a)));
        }
    }
