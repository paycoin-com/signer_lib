 ...
 */
class AdmissionSyntax : ASN1Object {
    ...
    private var contentsOfAdmissions: ASN1Sequence? = null
    ...
    private constructor(seq: ASN1Sequence) {
        when (seq.size()) {
            1 -> contentsOfAdmissions = DERSequence.getInstance(seq.getObjectAt(0))
            2 -> {
     ...
     */
    constructor(admissionAuthority: GeneralName, contentsOfAdmissions: ASN1Sequence) {
     ...
     */
    fun getContentsOfAdmissions(): Array<Admissions> {
        val admissions = arrayOfNulls<Admissions>(contentsOfAdmissions!!.size())
        var count = 0
        val e = contentsOfAdmissions!!.objects
    ...
    companion object {
        ...
        fun getInstance(obj: Any?): AdmissionSyntax {
            if (obj == null || obj is AdmissionSyntax) {
                return obj as AdmissionSyntax?
            }

            if (obj is ASN1Sequence) {
                return AdmissionSyntax(obj as ASN1Sequence?)
            }
