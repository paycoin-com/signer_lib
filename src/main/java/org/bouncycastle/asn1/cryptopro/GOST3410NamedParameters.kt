...
object GOST3410NamedParameters {
    ...
    private val cryptoProA = GOST3410ParamSetParameters(
            1024,
            ...
            BigInteger("68363196144955700784444165611827252895102170888761442055095051287550314083023"),
    ...
    private val cryptoProB = GOST3410ParamSetParameters(
            1024,
    ...
    private val cryptoProXchA = GOST3410ParamSetParameters(
            1024,
            ...
            BigInteger("91771529896554605945588149018382750217296858393520724172743325725474374979801"),
     ...
     */
    fun getByOID(
            oid: ASN1ObjectIdentifier): GOST3410ParamSetParameters {
    ...
    fun getByName(
            name: String): GOST3410ParamSetParameters? {
