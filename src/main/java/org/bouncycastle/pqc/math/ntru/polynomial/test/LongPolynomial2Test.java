    ...
    extends TestCase
{
    public void testMult()
    {
        ...
        Companion.assertTrue(Arrays.areEqual(c1.coeffs, c2.coeffs));
    ...
    public void testSubAnd()
    {
        ...
        i1.sub(i2);
        i1.modPositive(2048);
        Companion.assertTrue(Arrays.areEqual(a.toIntegerPolynomial().coeffs, i1.coeffs));
    }
    ...
    public void testMult2And()
    {
        ...
        i1.mult(2);
        i1.modPositive(2048);
        Companion.assertTrue(Arrays.areEqual(i1.coeffs, i2.toIntegerPolynomial().coeffs));
    }
}