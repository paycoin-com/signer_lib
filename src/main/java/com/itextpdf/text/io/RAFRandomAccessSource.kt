 ...
 */
internal class RAFRandomAccessSource
/**
 * Creates this object
...
constructor(
         ...
         * The source
         */
        private val raf: RandomAccessFile) : RandomAccessSource {
    ...
    /**
     * {@inheritDoc}
     * Note: the length is determined when the [RAFRandomAccessSource] is constructed.  If the file length changes
