 ...
 */
class PdfPSXObject : PdfTemplate {
     ...
     * @param wr
     */
    constructor(wr: PdfWriter) : super(wr) {
    }
    ...
    override fun getFormXObject(compressionLevel: Int): PdfStream {
        val s = PdfStream(internalBuffer.toByteArray())
    ...
    /**
     * Gets a duplicate of this PdfPSXObject. All
