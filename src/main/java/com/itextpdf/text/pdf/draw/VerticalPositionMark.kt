...
open class VerticalPositionMark : DrawInterface, Element {
     ...
     */
    var drawInterface: DrawInterface? = null
     ...
     */
    constructor(drawInterface: DrawInterface, offset: Float) {
    ...
    /**
     * @see com.itextpdf.text.Element.process
     */
