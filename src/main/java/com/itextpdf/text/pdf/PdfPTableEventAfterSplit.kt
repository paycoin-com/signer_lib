...
interface PdfPTableEventAfterSplit : PdfPTableEventSplit {

    /**
     * This method is called to indicate that table has been split. It's called after the tableLayout
     ...
     * information has to be repeated, like putting "still " in the top cell of a column where
     ...
     * callback tableLayout, that would fail in the case of the page break happening after the November
     ...
     * Note that determining the value of currentYear can be done in tableLayout
     ...
     * @param table
     * *            the PdfPTable in use
     * *
     * @param startRow
     * *            the first PdfPRow of the table body on the following page
     * *
     * @param startIdx
     ...
     * @since iText 5.4.3
     */
    fun afterSplitTable(table: PdfPTable, startRow: PdfPRow, startIdx: Int)
