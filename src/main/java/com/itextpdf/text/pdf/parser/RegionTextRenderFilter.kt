...
class RegionTextRenderFilter : RenderFilter {
     ...
     */
    constructor(filterRect: Rectangle) {
        this.filterRect = com.itextpdf.awt.geom.Rectangle(filterRect)
    }

    /**
     * @see com.itextpdf.text.pdf.parser.RenderFilter.allowText
     */
