 ...
 * @since 5.0.2
 */
class TextMarginFinder : RenderListener {
    private var textRectangle: Rectangle2D.Float? = null
    ...
    override fun renderText(renderInfo: TextRenderInfo) {
        if (textRectangle == null)
            textRectangle = renderInfo.descentLine.boundingRectange
        else
            textRectangle!!.add(renderInfo.descentLine.boundingRectange)

        textRectangle!!.add(renderInfo.ascentLine.boundingRectange)
     ...
     */
    val urx: Float
        get() = (textRectangle!!.x + textRectangle!!.width).toFloat()
     ...
     */
    val ury: Float
        get() = (textRectangle!!.y + textRectangle!!.height).toFloat()
     ...
     */
    val width: Float
        get() = textRectangle!!.width.toFloat()
     ...
     */
    val height: Float
        get() = textRectangle!!.height.toFloat()
