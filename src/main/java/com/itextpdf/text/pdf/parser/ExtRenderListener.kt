...
/**
 * Simply extends the [com.itextpdf.text.pdf.parser.RenderListener] interface to provide
 * additional methods.
 ...
 * @since 5.5.6
 */
interface ExtRenderListener : RenderListener {
     ...
     */
    fun modifyPath(renderInfo: PathConstructionRenderInfo)
     ...
     */
    fun renderPath(renderInfo: PathPaintingRenderInfo): Path

    /**
     * Called when the current path should be set as a new clipping path.

     * @param rule Either [PathPaintingRenderInfo.EVEN_ODD_RULE] or [PathPaintingRenderInfo.NONZERO_WINDING_RULE]
     */
    fun clipPath(rule: Int)
}
