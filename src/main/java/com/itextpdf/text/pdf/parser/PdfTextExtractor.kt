...
object PdfTextExtractor {
    ...
    @JvmOverloads fun getTextFromPage(reader: PdfReader, pageNumber: Int, strategy: TextExtractionStrategy = LocationTextExtractionStrategy(), additionalContentOperators: Map<String, ContentOperator> = HashMap<String, ContentOperator>()): String {
        val parser = PdfReaderContentParser(reader)
        return parser.processContent(pageNumber, strategy, additionalContentOperators).resultantText
    }
 ...
 * is important, use [PdfTextExtractor.getTextFromPage]
 * @param reader the reader to extract text from
 * *
 * @param pageNumber the page to extract text from
 * *
