...
class Matrix {
     ...
     *
     */
    private val vals = floatArrayOf(1f, 0f, 0f, 0f, 1f, 0f, 0f, 0f, 1f)
     ...
     * @param f
     */
    constructor(a: Float, b: Float, c: Float, d: Float, e: Float, f: Float) {
        vals[I11] = a
        vals[I12] = b
        vals[I13] = 0f
        vals[I21] = c
     ...
     */
    fun subtract(arg: Matrix): Matrix {
        val rslt = Matrix()
    ...
    override fun equals(obj: Any?): Boolean {
        ...
        return Arrays.equals(vals, obj.vals)
    }
    ...
    override fun hashCode(): Int {
        ...
        for (i in vals.indices)
            result = 31 * result + java.lang.Float.floatToIntBits(vals[i])
