...
(
        ...
        private val delegate: TextExtractionStrategy, vararg filters: RenderFilter) : FilteredRenderListener(delegate, filters), TextExtractionStrategy {
