...
interface PdfPageEvent {
     ...
     */
    fun onOpenDocument(writer: PdfWriter, document: Document)
     ...
     * @param document the document
     */
    fun onStartPage(writer: PdfWriter, document: Document)
     ...
     * @param document the document
     */
    fun onCloseDocument(writer: PdfWriter, document: Document)
     ...
     */
    fun onParagraph(writer: PdfWriter, document: Document, paragraphPosition: Float)
     ...
     */
    fun onParagraphEnd(writer: PdfWriter, document: Document, paragraphPosition: Float)
     ...
     */
    fun onChapter(writer: PdfWriter, document: Document, paragraphPosition: Float, title: Paragraph)
     ...
     * @param paragraphPosition the position the chapter will be written to
     */
    fun onChapterEnd(writer: PdfWriter, document: Document, paragraphPosition: Float)
     ...
     */
    fun onSection(writer: PdfWriter, document: Document, paragraphPosition: Float, depth: Int, title: Paragraph)
     ...
     * @param paragraphPosition the position the section will be written to
     */
    fun onSectionEnd(writer: PdfWriter, document: Document, paragraphPosition: Float)
     ...
     */
    fun onGenericTag(writer: PdfWriter, document: Document, rect: Rectangle, text: String)
}
