 ...
 */
(prefix: PdfName, baseversion: PdfName, extensionLevel: Int) {
     ...
     */
    val developerExtensions: PdfDictionary
        get() {
            val developerextensions = PdfDictionary()
            developerextensions.put(PdfName.BASEVERSION, baseversion)
            developerextensions.put(PdfName.EXTENSIONLEVEL, PdfNumber(extensionLevel))
    ...
    companion object {
        ...
        val ADOBE_1_7_EXTENSIONLEVEL3 = PdfDeveloperExtension(PdfName.ADBE, PdfWriter.PDF_VERSION_1_7, 3)
        /** An instance of this class for ETSI 1.7 Extension level 2.  */
        val ESIC_1_7_EXTENSIONLEVEL2 = PdfDeveloperExtension(PdfName.ESIC, PdfWriter.PDF_VERSION_1_7, 2)
        /** An instance of this class for ETSI 1.7 Extension level 5.  */
        val ESIC_1_7_EXTENSIONLEVEL5 = PdfDeveloperExtension(PdfName.ESIC, PdfWriter.PDF_VERSION_1_7, 5)
    }
}
