...
class PdfTargetDictionary : PdfDictionary {
     ...
     */
    constructor(nested: PdfTargetDictionary?) : super() {
     ...
     */
    constructor(child: Boolean) : super() {
        if (child) {
     ...
     */
    fun setEmbeddedFileName(target: String) {
        put(PdfName.N, PdfString(target, null))
    }
     ...
     */
    fun setFileAttachmentPagename(name: String) {
        put(PdfName.P, PdfString(name, null))
    }
     ...
     */
    fun setFileAttachmentPage(page: Int) {
        put(PdfName.P, PdfNumber(page))
    }
     ...
     */
    fun setFileAttachmentName(name: String) {
        put(PdfName.A, PdfString(name, PdfObject.TEXT_UNICODE))
    }
     ...
     */
    fun setFileAttachmentIndex(annotation: Int) {
        put(PdfName.A, PdfNumber(annotation))
    }
     ...
     */
    fun setAdditionalPath(nested: PdfTargetDictionary) {
