...
interface ExtraEncoding {
     ...
     */
    fun charToByte(text: String, encoding: String): ByteArray
     ...
     * @return the conversion or null if no conversion is supported
     */
    fun charToByte(char1: Char, encoding: String): ByteArray
     ...
     * @return the conversion or null if no conversion is supported
     */
    fun byteToChar(b: ByteArray, encoding: String): String
}
