 ...
 */
internal constructor(template: PdfTemplate, compressionLevel: Int // throws BadPdfFormatException
) : PdfStream() {
    ...
    companion object {
        ...
        val MATRIX = PdfLiteral("[1 0 0 1 0 0]")
    }
