...
(
        ...
        protected var certificate: X509Certificate?,
        /** The CertificateVerifier that was used for verifying.  */
        protected var verifierClass: Class<out CertificateVerifier>,
    ...
    override fun toString(): String {
        ...
        if (certificate != null) {
            sb.append(certificate!!.subjectDN.name)
            sb.append(" verified with ")
        }
        sb.append(verifierClass.name)
        sb.append(": ")
        sb.append(message)
        return sb.toString()
    }
