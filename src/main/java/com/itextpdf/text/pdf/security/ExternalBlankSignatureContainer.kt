 ...
 * @author Paulo Soares
 */
class ExternalBlankSignatureContainer : ExternalSignatureContainer {
    private var sigDic: PdfDictionary? = null

    constructor(sigDic: PdfDictionary) {
        this.sigDic = sigDic
    }

    constructor(filter: PdfName, subFilter: PdfName) {
