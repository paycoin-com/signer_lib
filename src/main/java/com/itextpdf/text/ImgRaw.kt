...
class ImgRaw : Image {
    ...
    constructor(width: Int, height: Int, components: Int, bpc: Int, data: ByteArray) : super(null as URL) {
        type = Element.IMGRAW
        ...
        if (components != 1 && components != 3 && components != 4)
            throw BadElementException(MessageLocalization.getComposedMessage("components.must.be.1.3.or.4"))
        if (bpc != 1 && bpc != 2 && bpc != 4 && bpc != 8)
            throw BadElementException(MessageLocalization.getComposedMessage("bits.per.component.must.be.1.2.4.or.8"))
