 ...
 */
@Deprecated("")
class XmpMMSchema : XmpSchema("xmlns:" + XmpMMSchema.DEFAULT_XPATH_ID + "=\"" + XmpMMSchema.DEFAULT_XPATH_URI + "\"") {
    companion object {

        private val serialVersionUID = 1408509596611634862L
        /** default namespace identifier */
        val DEFAULT_XPATH_ID = "xmpMM"
        /** default namespace uri */
        val DEFAULT_XPATH_URI = "http://ns.adobe.com/xap/1.0/mm/"
