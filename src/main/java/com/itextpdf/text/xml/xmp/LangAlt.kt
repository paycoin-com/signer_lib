...
class LangAlt : Properties {
     ...
     * Add a language.
     */
    fun addLanguage(language: String, value: String) {
     ...
     * Process a property.
     */
    protected fun process(buf: StringBuffer, lang: Any) {
    ...
    companion object {
        ...
        /** A serial version id.  */
        private val serialVersionUID = 4396971487200843099L

        /** Key for the default language.  */
        val DEFAULT = "x-default"
    }
