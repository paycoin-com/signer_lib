...
object XmpBasicProperties {
    ...
    fun setCreatorTool(xmpMeta: XMPMeta, creator: String) {
     ...
     */
    @Throws(XMPException::class)
    fun setCreateDate(xmpMeta: XMPMeta, date: String) {
     ...
     */
    @Throws(XMPException::class)
    fun setModDate(xmpMeta: XMPMeta, date: String) {
     ...
     */
    @Throws(XMPException::class)
    fun setMetaDataDate(xmpMeta: XMPMeta, date: String) {
     ...
     */
    @Throws(XMPException::class)
    fun setIdentifiers(xmpMeta: XMPMeta, id: Array<String>) {
        XMPUtils.removeProperties(xmpMeta, XMPConst.NS_DC, IDENTIFIER, true, true)
        for (i in id.indices) {
            xmpMeta.appendArrayItem(XMPConst.NS_DC, IDENTIFIER, PropertyOptions(PropertyOptions.ARRAY), id[i], null)
        }
    }
     ...
     */
    @Throws(XMPException::class)
    fun setNickname(xmpMeta: XMPMeta, name: String) {
