...
class GreekList : List {
     ...
     * @param    symbolIndent    indent
     */
    constructor(greeklower: Boolean, symbolIndent: Int) : super(true, symbolIndent.toFloat()) {
        isLowercase = greeklower
        setGreekFont()
    }
    ...
    override fun add(o: Element): Boolean {
        if (o is ListItem) {
            ...
            chunk.append(GreekAlphabetFactory.getString(first + items.size, isLowercase))
