...
interface DocListener : ElementListener {
    ...
    fun setPageSize(pageSize: Rectangle): Boolean  // [L4]
    ...
    fun setMargins(marginLeft: Float, marginRight: Float, marginTop: Float, marginBottom: Float): Boolean   // [L5]
     ...
     */
    fun setMarginMirroring(marginMirroring: Boolean): Boolean  // [L6]
     ...
     * @since    2.1.6
     */
    fun setMarginMirroringTopBottom(marginMirroringTopBottom: Boolean): Boolean  // [L6]
    ...
    fun setPageCount(pageN: Int)  // [L7]

    /**
     * Sets the page number to 0.
     */

    fun resetPageCount()  // [L8]
